...
parser.add_argument(
    "--num-train", type=int, default=30000, help="Number of training simulations to generate."
)
parser.add_argument(
    "--num-valid", type=int, default=3000, help="Number of validation simulations to generate."
)
parser.add_argument(
    "--num-test", type=int, default=3000, help="Number of test simulations to generate."
)
